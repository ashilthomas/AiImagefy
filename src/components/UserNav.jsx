        ...
        <div>
            {
                ...
                <div className='flex items-center gap-2 sm:gap-3'>
                    <button onClick={()=>navigate("/buyCredit")} className='flex items-center gap-2 bg-blue-100 px-4 sm-px-6 py-1.5 sm:py-3 rounded-full hover:scale-105
                    ...
                    <div className='relative group'>
                        ...
                        <div className='absolute hidden group-hover:block to-0 right-0 zx-10 text-black rounded pt-3'>
                            <ul className='list-none m-0 px-3 py-1.5 bg-blue-100 rounded-md text-sm border '>
